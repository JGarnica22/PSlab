...
if (species == "mouse"){
  ...
  #This analysis look for certain elements (such as active enhancers) around 100kb from genes of interest.
  ...
  for(g in names(Act.enh.gene)) {
    ...
    #overlaping ATACA and CHIP) annotating the position of the elements you want to search around your genes
