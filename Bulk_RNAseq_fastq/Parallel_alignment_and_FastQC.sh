...
cd /gpfs/projects/cek26/project
fastqc=fastqc
...
echo \#BSUB -q bsc_ls
echo \#BSUB -W 2:00
echo \#BSUB -eo /gpfs/projects/cek26/$bsub_reports/aligment_counts_$(cut -d'.' -f1 <<< $f).err
echo \#BSUB -oo /gpfs/projects/cek26/bsub_reports/aligment_counts_$(cut -d'.' -f1 <<< $f).out
echo \#BSUB -M 1800
